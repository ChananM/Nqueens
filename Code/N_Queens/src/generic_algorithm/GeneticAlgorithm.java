package generic_algorithm;/* generic_algorithm.GeneticAlgorithm.java
 *
...
public class GeneticAlgorithm
{
	...
	public GeneticAlgorithm(int n, int maxEphocs, double mutationRate) {
		MAX_LENGTH = n;
		START_SIZE = 40;
		MAX_EPOCHS = maxEphocs;
...
//			thisChromo.setFitness((worstScore - thisChromo.getConflicts()) * 100.0 / bestScore);
			thisChromo.setFitness(worstScore - thisChromo.getConflicts());
		}
	}
