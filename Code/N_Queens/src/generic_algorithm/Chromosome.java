package generic_algorithm;/* generic_algorithm.Chromosome.java
 *
 * generic_algorithm.Chromosome class used by generic_algorithm.GeneticAlgorithm.java
...
public class Chromosome implements Comparable<Chromosome>
{
	...
	public void computeConflicts() { //compute the number of conflicts to calculate fitness
		...
		int x = 0; //row
        int y = 0; //column
        int tempX = 0; //temp row
        int tempY = 0; //temp column
